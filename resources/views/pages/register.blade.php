            ...
            <form method="POST" action="{{ url('register') }}">
              ...
              <div class="row">
                  <div class="input-field col s10 l10 offset-s1 offset-l1">
                    <i class="material-icons prefix">lock</i>
                      <input  id="password_c" type="password" name="password_confirmation" required="">
              ...
              <div class="row">
                  <div class="input-field col s10 l10 offset-s1 offset-l1">
                    ...
                    <input  id="other_college" type="text" name="other_college" value="{{ old('other_college') }}">
              ...
              <div class="row">
                  <div class="input-field col s10 l10 offset-s1 offset-l1">
                    <i class="material-icons prefix">playlist_add</i>
                      <input  id="other_department" type="text" name="other_department" value="{{ old('other_department') }}">
              ...
              <div class="row center">
                  <div class="col s10 l6 offset-l3 offset-s1">
                    <button type="submit" class="btn waves-effect waves-light btn-large" >Register</button>
                  </div>
              </div>
            </form>
          </div>
